...
//                .antMatchers("/user").hasAnyRole("USER")
                ...
                .antMatchers("/auth/login", "/error", "/auth/registration", "/product", "/product/info/{id}", "/img/**", "/product/search", "/search_main","auth/search_main","/images/**", "/css/**", "/auth/login/search_main").permitAll()
